    ...
    (function ($) {
        ...
        $.widget("ech.multiselectfilter", {
            ...
            _handler:function (e) {
                ...
                if (!term) {
                    ...
                    this._trigger("filter", e, $.map(cache, function (v, i) {
                        if (v.search(regex) !== -1) {
                            rows.eq(i).show(); // Note: header row can't get filtered
                            return inputs.get(i);
                        }
            ...
            updateCache:function () {
                // each list item
                this.rows = this.instance.menu
                    .find(".ui-multiselect-checkboxes tr:not(.ui-multiselect-optgroup-label)").not(".mheader");
